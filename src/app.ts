...
import { createAttestationsApiService } from './services/attestationsApiService.js'
...
app.use('/api/attestations', createAttestationRouter(createAttestationsApiService(pool)))
